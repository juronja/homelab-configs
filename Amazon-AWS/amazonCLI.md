...
aws ec2 run-instances --image-id ami-00f07845aed8c0ee7 --count 1 --instance-type t2.micro --key-name id_amazon --security-groups dilute-right --private-dns-name-options HostnameType=resource-name,EnableResourceNameDnsARecord=True
